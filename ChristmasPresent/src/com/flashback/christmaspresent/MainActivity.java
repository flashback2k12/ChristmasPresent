 ...
 */
	public void BtnFirstCoupon (View view ) {
		...
		Gutschein1.setText("Ein Gutschein für einen Kinobesuch deiner Wahl!"); 
		mainisopen = false;
		checkBisopen = false; 
	}
/*
 ...
 */
		public void BtnThirdCoupon (View view ) {
				...
				Gutschein3.setText("Ein Gutschein für eine Massage deiner Wahl!"); 
				mainisopen = false;
				checkBisopen = false; 
			}		
/*
 ...
 */
			public void BtnFourthCoupon (View view ) {
					...
					Gutschein4.setText("Ein Gutschein für ein Candlelight Dinner!"); 
					mainisopen = false;
					checkBisopen = false; 
			}			
/*
 ...
 */
			public void BtnSixCoupon (View view ) {
				...
				Gutschein6.setText("Ein Gutschein für 4 Knutsch-Fotos im Passbildautomat (Ecke Löffelfamilie)!"); 
				mainisopen = false;
				checkBisopen = true; 
				checkB2isopen = false; 
			}			
 ...
 */
			public void BtnSevenCoupon (View view ) {
				...
				Gutschein7.setText("Ein Gutschein für einen DVD Marathon deiner Wahl mit Leckereien!"); 
				mainisopen = false;
				checkBisopen = true; 
				checkB2isopen = false; 
			}	
 ...
 */
			public void BtnEightCoupon (View view ) {
				...
				Gutschein8.setText("Ein Gutschein für die Erfüllung eines Wunsches von dir!"); 
				mainisopen = false;
				checkBisopen = true; 
				checkB2isopen = false; 
			}				
 ...
 */
			public void BtnNineCoupon (View view ) {
				...
				Gutschein9.setText("Ein Gutschein für ein Picknick!"); 
				mainisopen = false;
				checkBisopen = true; 
				checkB2isopen = false; 
			}
 ...
 */
			...
			public void BtnAntwort (View view) {
				...
				{
					FeldAntwort.setText("Schade :-((( Nächstes Jahr ist auch noch ein Jahr."); 
				}
				else
				{
